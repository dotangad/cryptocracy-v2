...
const TilesContainer = styled.div`
  ...
  > div {
    ...
    > div {
      transition: font-size 0.3s ease, font-weight 0.3s ease, color 0s ease,
        display 0s ease, visibility 0s ease;
      transition-delay: 0.5s;
    }
  }
`;
...
export interface ITilesF extends ITile {
  visited: boolean;
}

const UserTiles: React.FC<ITilesProps> = ({ tiles, tile, userId }: ITilesProps) => {
  ...
  return (
    <TilesContainer>
      ...
      {tilesf.map((tile_, i) =>
        tile_.visited ? (
          <InertiaLink
            href={`/admin/users/${userId}/tile/${tile_.id}`}
            key={i}
            className={
